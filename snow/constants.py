...
class URLConstants(enum.Enum):
    ...
    close_window = (
        "minigames/cjsnow/en_US/deploy/swf/ui/windows/cardjitsu_snowclose.swf"
    )
    error_handler = (
        "minigames/cjsnow/en_US/deploy/swf/ui/windows/cardjitsu_snowerrorhandler.swf"
    )
    ...
    player_selection = (
        "minigames/cjsnow/en_US/deploy/swf/ui/windows/cardjitsu_snowplayerselect.swf"
    )
    ...
    snow_payout = (
        "minigames/cjsnow/en_US/deploy/swf/ui/windows/cardjitsu_snowpayout.swf"
    )
