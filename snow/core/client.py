...
class Client:
    __slots__ = ['__reader', '__writer', 'server', 'logger',
                 ...
                 'client_type', 'media_url', 'event_num']
    ...
    async def send_json(self, **data):
        await self.send_tag('UI_CLIENTEVENT', self.event_num, 'receivedJson', json.dumps(data, separators=(',', ':')))
    ...
    def __repr__(self):
        return f'<Client {self.peer_name}>'
