    ...
    if action == "funnel_prepare_to_battle_4":
        ...
        for tile in p.server.tiles:
            await p.send_tag(
                ...
                0,
                1,
                tile.sprite_index.value,
                tile.tile_name.value,
                0,
                0,
                0,
                tile.tile_collection.value,
            )
        ...
        await p.send_tag(
            "O_HERE", 12, "0:1", 4.5, 2.5, 0, 1, 0, 0, 0, "", "0:1", 0, 1, 0
        )

        await p.send_tag(
            "O_HERE", 4, "0:1", 4.5, 2.5, 0, 1, 0, 0, 0, "", "0:1", 0, 1, 0
        )
        ...
        await p.send_tag(
            "O_HERE", 11, "0:1", 4.5, 6.1, 0, 1, 0, 0, 0, "Actor7", "0:6740002", 0, 0, 0
        )
